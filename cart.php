    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Жагсаалтыг устгах</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                <h3><b>Сагс жагсаалт</b></h3>
                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Үнэ:</b> <span class="price"><?php echo number_format($row['price']) ?></span></small></p>
                                <div>
                ...
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h4>Нийт:</h4></div>
                    <div class="col d-flex justify-content-end"><h4 id="grand-total">-</h4></div>
                </div>
            </div>
        </div>
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn btn-sm btn-flat btn-dark">Худалдан авах</a>
        </div>
    </div>
</section>
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Та сагсны жагсаалтаа хоослохдоо итгэлтэй байна уу?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Та сагсанд байгаа зүйлийг устгахдаа итгэлтэй байна уу?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>