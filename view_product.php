    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p class="m-0"><small>Зохиолч: <?php echo $author ?></small></p>
                <div class="fs-5 mb-5">
               ₮ <span id="price"><?php echo number_format($inv[0]['price']) ?></span>
                <br>
                <span><small><b>Боломжтой нөөц:</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">Холбоотой бүтээгдэхүүн</h2>
                ...
                <div class="card h-100 product-item">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <?php endforeach; ?>
                            <p class="m-0"><small>Зохиогч: <?php echo $row['author'] ?></small></p>
                        </div>
                    </div>
                    <!-- Product actions-->
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status=='success'){
                        alert_toast("Бүтээгдэхүүнийг сагсанд нэмсэн.",'success')
