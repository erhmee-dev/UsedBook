...
<section class="py-5">
    <div class="container">
        <div class="card rounded-0">
            ...
            <h3 class="text-center"><b>Төлбөр төлөх</b></h3>
            ...
            <form action="" id="place_order">
                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <label for="" class="control-label">Захиалгын төрөл</label>
                    </div>
                    <div class="form-group d-flex pl-2">
                        <div class="custom-control custom-radio">
                          ...
                          <label for="customRadio4" class="custom-control-label">Татаж авах зориулалттай</label>
                        </div>
                        <div class="custom-control custom-radio ml-3">
                          ...
                          <label for="customRadio5" class="custom-control-label">Хүргэлтийн зориулалттай</label>
                        </div>
                      </div>
                        <div class="form-group col address-holder">
                            <label for="" class="control-label">Хүргэлтийн хаяг</label>
                        ...
                        <div class="col">
                            <span><h4><b>Нийт үнэ:</b> <?php echo number_format($total) ?></h4></span>
                        </div>
                        <hr>
                        <div class="col my-3">
                        <h4 class="text-muted">Төлбөрийн нөхцөл</h4>
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-dark">Бэлэн мөнгө Хүргэлт</button>
...
$(function(){
    ...
    $('#place_order').submit(function(e){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("алдаа гарлаа","error")
                end_loader();
            },
            success:function(resp){
                if(!!resp.status && resp.status == 'success'){
                    alert_toast("Захиалгыг амжилттай байршууллаа.","success")
                    setTimeout(function(){
                        location.replace('./')
                    },2000)
                }else{
