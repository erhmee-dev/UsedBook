            ...
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="./">Нүүр</a></li>
                        <?php 
                        ...
                        <?php endwhile; ?>
                        <?php if($count_cats > 3): ?>
                        <li class="nav-item"><a class="nav-link" href="./?p=view_categories">Бүх Categories</a></li>
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link" href="./?p=about">Бидний тухай</a></li>
                    </ul>
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        <button class="btn btn-outline-dark ml-2" id="login-btn" type="button">Нэвтрэх</button>
                        <?php else: ?>
                        <a class="text-dark mr-2 nav-link" href="./?p=cart">
                           ...
                           Сагс
                            ...
                            <a href="./?p=my_account" class="text-dark  nav-link"><b> Сайн уу, <?php echo $_settings->userdata('firstname')?>!</b></a>
