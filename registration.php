...
<div class="container-fluid">
    <form action="" id="registration">
        ...
        <h3 class="text-center">Шинээр хэрэглэгч бүртгүүлэх
        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-5 border-right">
                ...
                <div class="form-group">
                    <label for="" class="control-label">Утасны дугаар</label>
            ...
            <div class="col-lg-7">
                ...
                <div class="form-group d-flex justify-content-between">
                    <a href="javascript:void()" id="login-show">Бүртгэлтэй байна</a>
                    <button class="btn btn-primary btn-flat">Бүртгүүлэх</button>
                </div>
            </div>
        </div>
    </form>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Бүртгэл амжилттай бүртгэгдлээ",'success')
                        setTimeout(function(){
                            location.reload()
                        },2000)
