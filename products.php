    ...
    <div class="container-fluid row">
        ...
        <div class="col-md-3 border-right mb-2 pb-3">
            ...
            <div class="list-group">
                <a href="./?p=products&c=<?php echo $_GET['c'] ?>" class="list-group-item <?php echo !isset($_GET['s']) ? "active" : "" ?>">Бүгд</a>
                <?php 
        ...
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?>">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="book-tab" data-toggle="tab" href="#book" role="tab" aria-controls="book" aria-selected="true">Бүх Ном</a>
                </li>
                <?php if(isset($_GET['c'])): ?>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="details-tab" data-toggle="tab" href="#details" role="tab" aria-controls="details" aria-selected="false">Дэлгэрэнгүй мэдээлэл</a>
                </li>
                <?php endif; ?>
            </ul>
                ...
                <div class="tab-pane fade show active" id="book">
                    <?php 
                            if(isset($_GET['search'])){
                                echo "<h4 class='text-center'><b>Хайлтын үр дүн '".$_GET['search']."'</b></h4>";
                            }
                        ?>
                    ...
                    <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-3">
                            ...
                            <div class="card product-item">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <a class="btn btn-flat btn-primary "   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">Харах</a>
                                    </div>
                        ...
                        <?php 
                            if($products->num_rows <= 0){
                                echo "<h4 class='text-center'><b>Бүтээгдэхүүн жагсаалтад ороогүй байна.</b></h4>";
                            }
                        ?>
                    </div>
                </div>
