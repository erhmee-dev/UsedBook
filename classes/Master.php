...
Class Master extends DBConnection {
	...
	function save_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Шинэ Category амжилттай хадгаллаа.");
			else
				$this->settings->set_flashdata('success',"Category амжилттай шинэчлэгдлээ.");
		}else{
			$resp['status'] = 'failed';
	...
	function delete_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Category амжилттай устаглаа.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_sub_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Шинэ Sub Category амжилттай хадгаллаа.");
			else
				$this->settings->set_flashdata('success',"Sub Category амжилттай  шинэчлэгдлээ.");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_sub_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Sub Category амжилттай  устаглаа.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_product(){
		...
		if($save){
			...
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Шинэ Ном амжилттай  хадгаллаа.");
			else
				$this->settings->set_flashdata('success',"Ном амжилттай шинэчлэгдлээ .");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_product(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Ном амжилттай устаглаа.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_inventory(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Шинэ бараа материалыг амжилттай хадгаллаа.");
			else
				$this->settings->set_flashdata('success',"Шинэ бараа материалыг амжилттай  шинэчлэгдлээ.");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_inventory(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Шинэ бараа материалыг амжилттай устаглаа.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function register(){
		...
		if($check > 0){
			$resp['status'] = 'failed';
			$resp['msg'] = "Email бүртгэлтэй байна..";
			return json_encode($resp);
			exit;
		}
		if(empty($id)){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Бүртгэл амжилттай үүслээ.");
			else
				$this->settings->set_flashdata('success',"Бүртгэлийг амжилттай шинэчилэгдлээ.");
			foreach($_POST as $k =>$v){
	...
	function delete_order(){
		...
		if($delete){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Захиалгыг амжилттай устгалаа");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function update_order_status(){
		...
		if($update){
			$resp['status'] ='success';
			$this->settings->set_flashdata("success"," Захиалгыг амжилттай шинэчлэгдтэлээ .");
		}else{
			$resp['status'] ='failed';
	...
	function pay_order(){
		...
		if($update){
			$resp['status'] ='success';
			$this->settings->set_flashdata("success"," Захиалгын төлбөрийн төлөвийг амжилттай шинэчилсэн.");
		}else{
			$resp['status'] ='failed';
			$resp['err'] =$this->conn->error;
		}
