                ...
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <table class="table table-stripped text-dark">
                        ...
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Он сар өдөр цаг</th>
                                <th>Гүйлгээ ID</th>
                                <th>Хэмжээ</th>
                                <th>захиалгын байдал</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                            <?php if($row['status'] == 0): ?>
                                                <span class="badge badge-light text-dark">Хүлээгдэж байгаа төлбөр</span>
                                            <?php elseif($row['status'] == 1): ?>
                                                <span class="badge badge-primary">Хүлээгдэж байна</span>
                                            <?php elseif($row['status'] == 2): ?>
                                                <span class="badge badge-warning">Өнөөдөр хүргэлтээр гарна</span>
                                            <?php elseif($row['status'] == 3): ?>
                                                <span class="badge badge-success">Хүргэсэн</span>
                                            <?php else: ?>
...
<script>
        ...
        $.ajax({
            ...
            success:function(resp){
                if(typeof resp == 'object' && resp.status == 'success'){
                    alert_toast("Захиалга амжилттай цуцлагдлаа",'success')
                    setTimeout(function(){
                        location.reload()
                    },2000)
                }else{
    ...
    $(function(){
        $('.view_order').click(function(){
            uni_modal("захиалгын мэдээлэл","./admin/orders/view_order.php?view=user&id="+$(this).attr('data-id'),'large')
        })
        $('table').dataTable();
